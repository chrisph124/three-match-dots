...
| **Meta**              | `src/meta/`                                 | No (RN/MMKV)           | One board + one score; Journey state; persistence                                                                                                                       | `use-game-state.ts`, `use-journey-state.ts`, `score-storage.ts` (MMKV keys `'score'`, `'sweeps.N'`)                                             |
